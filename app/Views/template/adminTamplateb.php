	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="header" class="header navbar-default">
			...
			<div class="navbar-header">
				<a href="<?php echo URL?>" class="navbar-brand"><img src="../../img/logo.png" alt="logo"></a>
		...
		<div id="sidebar" class="sidebar">
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					<li class="nav-profile">
						<a href="javascript:;" data-toggle="nav-profile">
							...
							<div class="image">
								<img src="<?php URL?>/assets/img/user/user-13.png" alt="" />
							</div>
							<div class="info">
				...
				<!-- begin sidebar nav -->
					...
					<li class="active"><a href="<?= URL ?>admin/user/index "><i class="fas fa-code-branch"></i> <span> details of orders</span></a></li>
...
$(".confirm").click(function(){
	alert("you have confirmed the product");


})
$(".cancel").click(function(){
	alert("you have cancelled the product");
})
});
